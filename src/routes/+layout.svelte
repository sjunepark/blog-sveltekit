	...
	<footer class="group mt-32 flex-none">
		<div class="border-t border-border px-4 pb-16 pt-10 sm:px-8 lg:px-12">
			<div class="mx-auto max-w-2xl lg:max-w-5xl">
				<div class="flex items-center justify-center gap-6 sm:justify-end">
					<p
						class="text-center font-normal text-secondary-foreground group-hover:text-foreground sm:text-start"
					>
						<span class="whitespace-nowrap">Thanks for visiting,</span><br class="sm:hidden" />
						<span class="whitespace-nowrap"
							>have a wonderful day<br class="sm:hidden" />
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 20 20"
								class="inline h-5 w-5 animate-bounce fill-secondary-foreground align-bottom transition duration-300 group-hover:fill-primary"
							>
								<path
